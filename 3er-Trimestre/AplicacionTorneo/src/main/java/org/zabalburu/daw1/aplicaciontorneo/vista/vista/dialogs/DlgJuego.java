 ...
 * @author DAW1
 */
public class DlgJuego extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DlgJuego.class.getName());
     ...
     */
    public DlgJuego(java.awt.Frame parent, boolean modal, Juego juego) {
        super(parent, modal);
        this.juego = juego;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DlgJuego dialog = new DlgJuego(new javax.swing.JFrame(), true, null);
