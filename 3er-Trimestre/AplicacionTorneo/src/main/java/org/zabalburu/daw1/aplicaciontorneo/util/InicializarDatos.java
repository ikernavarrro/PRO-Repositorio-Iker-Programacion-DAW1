...
public class InicializarDatos {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // --- BORRADO DE TABLAS ---
            try { stmt.executeUpdate("DROP TABLE PARTIDAS"); } catch (SQLException ex) {}
            try { stmt.executeUpdate("DROP TABLE JUGADORES"); } catch (SQLException ex) {}
            try { stmt.executeUpdate("DROP TABLE JUEGOS"); } catch (SQLException ex) {}
            ...
            for (String secuencia : secuencias) {
                try { stmt.executeUpdate("DROP SEQUENCE %s".formatted(secuencia)); } catch (SQLException ex) {}
